        ...
        {steps.map((step, index) => (
          ...
          >
            ...
            >
              ...
              >
                <span className="text-cyan-600 dark:text-cyan-500 font-mono text-sm mt-1">0{index + 1} {"//"}</span>
                ...
                <button className="text-slate-400 hover:text-cyan-500 transition-colors mt-1">
                  {expandedStep === index ? <ChevronDown size={20} /> : <ChevronRight size={20} />}
                </button>
              </div>
              ...
              <AnimatePresence>
                {expandedStep === index && (
                  ...
                  >
                    <div className="p-6 pt-2 pl-14 space-y-3">
                      {loadingSub === index ? (
                        ...
                        subSteps[index]?.map((sub, i) => (
                          <motion.div 
                            ...
                            className="flex items-start gap-3 text-sm text-slate-600 dark:text-slate-400 font-mono"
                          >
