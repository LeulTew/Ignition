...
![Stack](https://img.shields.io/badge/stack-Next.js_16_|_FastAPI_|_Gemini_3_Flash-black.svg)
![Repo](https://img.shields.io/badge/repo-connected-blue.svg)

**Repo URL**: [https://github.com/LeulTew/Ignition](https://github.com/LeulTew/Ignition)
...
3.  **Classification**: Gemini 3 Flash-Preview categorizes the intent.
4.  **Synthesis**:
    - If `OK`: `services.py` prompts Gemini 3 Flash-Preview for a structured JSON response.
...
| `GEMINI_MODEL_CHAIN` | _Optional_. Comma-separated models (default: `gemini-3-flash-preview`). |
...
| **AI Core**    | Google Gemini 3 Flash Preview                     |
...
[**Report Bug**](https://github.com/LeulTew/Ignition/issues)
